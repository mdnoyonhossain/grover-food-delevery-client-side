                        ...
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0 _grover_grocery_list">
                            ...
                            </li>
                            {
                                user?.email ?
                                    <>
                                        <li className="nav-item _grover_grocery_list_item">
                                            <Link to="/my-reviews" className="nav-link _grover_grocery_list_link"
                                                aria-disabled="true">My reviews</Link>
                                        </li>
                                        <li className="nav-item _grover_grocery_list_item">
                                            <Link to="/add-service" className="nav-link _grover_grocery_list_link"
                                                aria-disabled="true">Add service</Link>
                                        </li>
                                        <li className="nav-item _grover_grocery_list_item">
